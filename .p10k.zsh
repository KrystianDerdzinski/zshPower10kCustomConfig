# Generated by Powerlevel10k configuration wizard on 2022-01-21 at 22:19 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    my_ecversion            # ec
    my_ecdockerversion      # ec docker image version
  ...
  function prompt_my_ecversion() {
    build_gradle_path=build.gradle
    if test -f "$build_gradle_path"; then
      ecversion="$(grep "shopVersion" $build_gradle_path | awk '{print $3}' | sed 's/"//g' )"
      p10k segment -f 215 -i '' -t "ec: ${ecversion}"
    fi
  }

  function prompt_my_ecdockerversion() {
    docker_compose_path=src/docker/docker-compose.yml
